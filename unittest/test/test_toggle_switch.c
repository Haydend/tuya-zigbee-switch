...
void _setup_toggle_switch(toggle_switch_t *toggle_switch, bool pullUp)
{
  // Setup Encoder
  toggle_switch->pin = 1;
  ...
  toggle_switch_init(toggle_switch, pullUp);
...
void test_pin_goes_low(void)
{
  ...
  _setup_toggle_switch(&toggle_switch, true);
...
{
  toggle_switch_t toggle_switch = {};
  _setup_toggle_switch(&toggle_switch, false); // Set as Pull Down
